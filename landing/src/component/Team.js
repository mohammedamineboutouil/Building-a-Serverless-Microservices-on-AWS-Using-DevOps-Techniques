                                ...
                                <div className="team-social mt-4 pt-2">
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item">
                                            <Link to="#" className="text-reset"><i
                                                className="mdi mdi-facebook"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="text-reset"><i
                                                className="mdi mdi-twitter"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="text-reset"><i
                                                className="mdi mdi-google"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="text-reset"><i
                                                className="mdi mdi-pinterest"></i></Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <Row>
                            <Col lg="12">
                                <div className="title-box text-center">
                                    ...
                                    <p className="text-muted f-17 mt-3">Vivamus ac nulla ultrices laoreet neque mollis
                                        mi morbi elementum mauris sit amet arcu <br/> fringilla auctor In eleifend
                                        maximus nisi sed vulputate.</p>
                        ...
                        <Row className="justify-content-center">
                            <Col lg={9}>
                                <div className="text-center">
                                    ...
                                    <p className="text-muted mt-3">Quisque iaculis urna eu magna semper quis ultrices
                                        lectus efficitur
                                        Praesent convallis
                                        velit urna, vitae tristique tellus feugiat a maecenas diam metus convallis id
                                        cursus vel
                                        tellus.<br/> Curabitur ullamcorper feugiat convallis.</p>
                                    <div className="mt-4 pt-2">
                                        <Link to="#" className="btn btn-soft-primary btn-round mr-3 btn-rounded">Request
                                            a demo</Link>
                                        <Link to="#" className="btn btn-primary btn-round btn-rounded">Get Started
                                            Now</Link>
                                    </div>
                                </div>
                            </Col>
